...
sap.ui.controller("sap.ui.demo.myFiori.view.AddCompanyContact", {

	
	onInit: function () {
    // set explored app's demo model on this sample
    //this.getView().setModel(SectorModel);
    //var myTest= sap.ui.getCore().SelectedItem.coyName;
    //var data = {SEL_COMPANY_NAME : myTest, dec_key : "0001"}; 
    //var coyModel = new sap.ui.model.json.JSONModel();  
    //coyModel.setData(data);  
     //this.getView().setModel(coyModel);  
  ...
  onAfterRender: function(){
	...
	handleAddObject : function (evt) { 
		 ...
		 var oEntry = {};
		 oEntry.ID="16";
		 oEntry.COMPANY_NAME=view.byId("company").getValue();
		 oEntry.COMPANY_WEBSITE= view.byId("companyWebsite").getValue();
		 oEntry.INDUSTRY_SECTOR=view.byId("industry").getValue();
		 oEntry.FIRSTNAME=view.byId("firstname").getValue();
		 oEntry.LASTNAME=view.byId("surname").getValue();
		 oEntry.POSITION=view.byId("position").getValue();
		 oEntry.EMAIL_ADDRESS=view.byId("emailaddress").getValue();
		 oEntry.PHONE_NUMBER=view.byId("personPhone").getValue();
	...
	cancelAddObject : function (evt) {
		sap.ui.getCore().byId("app").getController().to("Detail");  
...
//				alert("The Delete failed");}); 
		...
		var oEntry = {};
		 ...
		 oEntry.INDUSTRY_SECTOR=view.byId("industry");
